...
@section('contents')
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="close" class="form-control" placeholder="Open" value="{{ $saham->close }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">High</label>
            <input type="text" name="high" class="form-control" placeholder="High" value="{{ 0 }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">Low</label>
            <input type="text" name="low" class="form-control" placeholder="Low" value="{{ 0 }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">Close</label>
            <input type="text" name="close" class="form-control" placeholder="Close" value="{{ 0 }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">Volume</label>
            <input type="text" name="volume" class="form-control" placeholder="Volume" value="{{ 0 }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
